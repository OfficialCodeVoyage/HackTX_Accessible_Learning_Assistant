...
import { Input, Textarea } from "@/components/ui/input"; // Now includes Textarea
...
export default function Chat() {
  ...
  const startListening = () => {
    ...
    recognizer.current = SpeechRecognitionConstructor
    ...
    if (recognizer.current) {
      ...
      recognizer.current.lang = "en-US"; // Set language as needed
      recognizer.current.start();

      recognizer.current.onresult = (event: SpeechRecognitionEvent) => {
      ...
      recognizer.current.onerror = (event: SpeechRecognitionErrorEvent) => {
